...
@WasmImport(MODULE, "bridge_read_int8")
private external fun bridge_read_int8(addr: Int): Byte

@WasmImport(MODULE, "bridge_read_int16")
private external fun bridge_read_int16(addr: Int): Short

@WasmImport(MODULE, "bridge_read_int32")
private external fun bridge_read_int32(addr: Int): Int
...
@WasmImport(MODULE, "_malloc")
internal external fun _malloc(size: Int): Int

@WasmImport(MODULE, "_free")
internal external fun _free(ptr: Int)

// Core Capstone
@WasmImport(MODULE, "_cs_open")
internal external fun _cs_open(arch: Int, mode: Int, handlePtr: Int): Int

@WasmImport(MODULE, "_cs_close")
internal external fun _cs_close(handlePtr: Int): Int

@WasmImport(MODULE, "_cs_option")
internal external fun _cs_option(handle: Int, type: Int, value: Int): Int

@WasmImport(MODULE, "_cs_errno")
internal external fun _cs_errno(handle: Int): Int
...
@WasmImport(MODULE, "_cs_free")
internal external fun _cs_free(insnPtr: Int, count: Int)

@WasmImport(MODULE, "_cs_malloc")
internal external fun _cs_malloc(handle: Int): Int

// Details / Names
@WasmImport(MODULE, "_cs_reg_name")
private external fun _cs_reg_name(handle: Int, regId: Int): Int
...
private external fun _cs_regs_access(handle: Int, insnPtr: Int, regsRead: Int, readCount: Int, regsWrite: Int, writeCount: Int): Int

// Architecture Registration
@WasmImport(MODULE, "_cs_arch_register_x86")
external fun cs_arch_register_x86()

@WasmImport(MODULE, "_cs_arch_register_arm")
external fun cs_arch_register_arm()

@WasmImport(MODULE, "_cs_arch_register_aarch64")
external fun cs_arch_register_aarch64()


object CapstoneWasi {
    /**
     * Helpers using BRIDGE functions for safe memory access to foreign module.
     * We do NOT use UnsafeWasmMemory directly for reading foreign pointers.
     */
