...
internal class X86UnionOpInfo : Structure() {
    ...
    override fun getFieldOrder() = listOf("prefix", "opcode", "rex", "addr_size",
        "modrm", "sib", "disp", "sib_index", "sib_scale", "sib_base", "sse_cc", "avx_cc",
        "avx_sae", "avx_rm", "eflags", "fpu_flags", "op_count", "op")
}
