...
//    "AARCH64_SVEVECLENSPECIFIER_" to AArch64SveVectorLengthSpecifier.entries.map { it.name to it.value },
...
//    val output = Path("/Volumes/T7/AndroidProjects/Il2CPPDecompiler/capstone/interop/scripts", "WasmEnumValues.kt")
