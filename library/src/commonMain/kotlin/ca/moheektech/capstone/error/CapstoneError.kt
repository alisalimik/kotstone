...
sealed class CapstoneError : Exception() {
     ...
     */
    data class InvalidHandle(
        override val message: String = "Invalid Capstone handle"
    ) : CapstoneError()
     ...
     */
    data class MemSetup(
        override val message: String = "Dynamic memory management uninitialized"
    ) : CapstoneError()
    ...
    data class UnsupportedVersion(
        override val message: String = "Unsupported Capstone version"
    ) : CapstoneError()
     ...
     */
    data class Diet(
        override val message: String = "Access irrelevant data in diet engine"
    ) : CapstoneError()
     ...
     */
    data class SkipData(
        override val message: String = "Access irrelevant data in SKIPDATA mode"
    ) : CapstoneError()
