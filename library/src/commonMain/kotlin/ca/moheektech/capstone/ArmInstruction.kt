...
data class ArmInstruction(
    ...
    val arm: ArmInstructionDetail = (detail.archDetail as? ArchDetail.ARM)?.detail
        ?: throw IllegalArgumentException("ArmInstruction requires generic detail to have ARM specific detail")
    ...
    val operands: List<ArmOperand> get() = arm.operands
    val cc: ArmConditionCode get() = arm.cc
}
