...
data class X86Instruction(
    ...
    val x86: X86InstructionDetail = (detail.archDetail as? ArchDetail.X86)?.detail
        ?: throw IllegalArgumentException("X86Instruction requires generic detail to have X86 specific detail")
    ...
    val operands: List<X86Operand> get() = x86.operands
    val imm: Long? get() = operands.firstOrNull { it.type == ca.moheektech.capstone.arch.X86OpType.IMM }?.imm
}
