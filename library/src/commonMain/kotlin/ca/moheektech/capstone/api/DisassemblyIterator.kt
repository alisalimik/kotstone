 ...
 *
 * This iterator allows streaming disassembly of large binaries without
 * loading all instructions into memory at once.
 *
 * Example usage:
 * ```kotlin
 ...
 * ```
 */
class DisassemblyIterator internal constructor(
     ...
     *
     * Note: This defeats the purpose of using an iterator for memory efficiency.
     * Use only for small code segments.
     *
