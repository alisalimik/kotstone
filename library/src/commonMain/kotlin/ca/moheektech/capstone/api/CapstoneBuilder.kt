...
class CapstoneBuilder(
     ...
     * Default: null (use architecture default)
     */
     ...
     * instead of stopping at the first non-code byte.
     * Default: false
     */
     ...
     *
     * When enabled, immediate values are printed as unsigned integers instead of signed.
     * Default: false
     */
     ...
     *
     * Architecture-specific option for: ARM, PPC, AArch64
     * Default: false
     */
    ...
    fun build(): CapstoneEngine {
        ...
        options.forEach { option ->
            engine.setOption(option).getOrThrow()
        }
